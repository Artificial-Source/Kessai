...
- Use the next shipped version as the real in-app updater test from `0.4.1`
- Verify update discovery, download, install, and relaunch from an installed app
- Confirm post-update behavior: settings opens cleanly, app logo renders, and existing user data persists
